...
/*
	...
	<div id="slides">
			<img src="../../../../../../slidesjs.com/examples/standard/img/slide-1.jpg" width="570" height="270" alt="Slide 1">
			<img src="../../../../../../slidesjs.com/examples/standard/img/slide-2.jpg" width="570" height="270" alt="Slide 2">
			<img src="../../../../../../slidesjs.com/examples/standard/img/slide-3.jpg" width="570" height="270" alt="Slide 3">
			<img src="../../../../../../slidesjs.com/examples/standard/img/slide-4.jpg" width="570" height="270" alt="Slide 4">
	</div>
...
(function($) {
  $.widget("js.slides", {
		options: {
			width: 415, // [Number] Define the slide width
			responsive: false, // [Boolean] slideshow will scale to its container
			height: 365, // [Number] Define the slide height
